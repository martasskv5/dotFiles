...
keybinds_conf="$HOME/.config/niri/configs/Keybinds.conf"
user_keybinds_conf="$HOME/.config/niri/UserConfigs/UserKeybinds.conf"
laptop_conf="$HOME/.config/niri/UserConfigs/Laptops.conf"
...
display_keybinds=$("$HOME/.config/niri/scripts/keybinds_parser.py" "${files[@]}")
